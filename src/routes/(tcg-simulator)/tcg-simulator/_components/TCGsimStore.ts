...
export const boardAreaInfoStore = writable<boardAreaInfoModel>({
    top: 0,
    left: 0,
    right: 0,
    bottom: 0
})
export const handAreaInfoStore = writable<handAreaInfoModel>({
    top: 0,
    left: 0,
    right: 0,
    bottom: 0
})
export const deckAreaInfoStore = writable<deckAreaInfoModel>({
    top: 0,
    left: 0,
    right: 0,
    bottom: 0
