<script lang="ts">
  ...
  import { modeStore } from "./tcg-simulator/_components/TCGsimStore";
  import { deckShuffle } from "./tcg-simulator/_components/deckAndHand.svelte";
  import {
    boardListStore,
    handListStore,
    deckListStore,
    ...
    exDeckListStore,
  } from "./tcg-simulator/_components/TCGsimStore";
  import type { deckCardModel } from "./tcg-simulator/_components/TCGsimModel";
