...
<div
  class="coin {flip ? 'flip' : ''} {openFrontFlip
    ? 'openFrontFlip'
    : ''} {openBackFlip ? 'openBackFlip' : ''}"
  on:click={coinToss}
>
  <div class="front">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 284 284"
      ><g fill="none" fill-rule="evenodd"
        ...
        ><circle fill="#E9ACB5" cx="49" cy="174" r="24" /><circle
          ...
          cy="180"
          r="24"
        /><ellipse fill="#000" cx="142.5" cy="170.5" rx="7.5" ry="3.5" /></g
      ></svg
    >
  </div>
  <div class="back">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 284 284"
      ><g fill="none" fill-rule="evenodd"
        ...
        /><circle fill="#E9ACB5" cx="49" cy="174" r="24" /><circle
          ...
          cy="174"
          r="24"
        /><ellipse fill="#000" cx="142.5" cy="170.5" rx="7.5" ry="3.5" /><path
